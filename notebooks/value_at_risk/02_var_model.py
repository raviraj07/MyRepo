...
f_ret = spark.table(market_return_table).filter(F.col('date') <= '2021-06-01')
s_ret = spark.table(stock_return_table).filter(F.col('date') <= '2021-06-01')
...
# DBTITLE 1,Package model as pyfunc
